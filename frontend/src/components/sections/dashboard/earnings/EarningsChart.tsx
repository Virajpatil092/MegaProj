...
type EarningsChartProps = {
  ...
  ddosProbability: number | null; // Add ddosProbability as a prop
  sx?: SxProps;
};
...
const EarningsChart = ({ chartRef, ddosProbability, ...rest }: EarningsChartProps): ReactElement => {
      ...
      series: [
        {
          ...
          data: [
            {
              value: ddosProbability !== null ? ddosProbability : 0, // Set chart value based on ddosProbability
            },
          ],
        },
      ],
    }),
    [ddosProbability, theme]
  );
